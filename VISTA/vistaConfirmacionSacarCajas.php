...
$confirmacion = $_SESSION['confirmacionSacarCajas'];
?> 
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <div class="main">
                ...
                <section class="caja">
                   ...
                   <?php if ($confirmacion===true){?>
                    <p style="color:green">La caja ha salido correctamente</p>
                        <?php }else if ($confirmacion===false) {?>
                     <p style="color:red">Error en la salida de caja</p>
                        <?php } else {?>
                     <p style="color:yellow"><?php echo $confirmacion ?></p>
                        <?php } ?>
                    </div>
                    <div id="botonesConfirmacion">
                        <a href="FormularioSacarCaja.php" class="button-2" id="atras">Atrás</a>
