...
$confirmacion = $_SESSION['confirmacionDevolverCajas'];
?> 
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <div class="main">
                ...
                <section class="caja">
                   ...
                   <?php if ($confirmacion==true){?>
                    <p style="color:green">Devolución completada</p>
                        <?php }else {?>
                     <p style="color:red">Error en la devolución</p>
                        <?php }?>
                    </div>
                    <div id="botonesConfirmacion">
                        <a href="FormularioElegirCaja.php" class="button-2" id="atras">Atrás</a>
