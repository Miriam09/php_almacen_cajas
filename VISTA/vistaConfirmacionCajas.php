...
$confirmacion = $_SESSION['confirmacionCajas'];
?> 
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <div class="main">
                ...
                <section class="caja">
                   ...
                   <?php if ($confirmacion==true){?>
                    <p style="color:green">Caja añadida correctamente</p>
                        <?php }else {?>
                     <p style="color:red">No se ha podido añadir la caja</p>
                        <?php }?>
                    </div>
                    <div id="botonesConfirmacion">
                        <a href="FormularioCaja.php" class="button-2" id="atras">Atrás</a>
